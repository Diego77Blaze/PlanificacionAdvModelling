...
(:init
    ...
    (= (gasolina_requerida pizzeria gas_station) 10)
    (= (gasolina_requerida casa1 gas_station) 10)
    (= (gasolina_requerida casa2 gas_station) 10)
    (= (gasolina_requerida gas_station pizzeria) 10)
    (= (gasolina_requerida gas_station casa1) 10)
    (= (gasolina_requerida gas_station casa2) 10)
    ...
    (= (distancia casa1 pizzeria) 20)
    (= (distancia pizzeria gas_station) 10)
    (= (distancia casa1 gas_station) 10)
    (= (distancia casa2 gas_station) 10)
    (= (distancia gas_station pizzeria) 10)
    (= (distancia gas_station casa1) 10)
    (= (distancia gas_station casa2) 10)

    (= (umbral_gasolina) 20) ;definicion del umbral de gasolina con el que debería ir a repostar como mínimo


    (at gas_station moto1) ;definición de dónde se encuentra la moto inicialmente
